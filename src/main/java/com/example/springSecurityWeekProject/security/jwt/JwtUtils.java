...
import com.example.springSecurityWeekProject.security.services.UtenteDetailsImpl;
...
public class JwtUtils {
    ...
    public String creaJwtToken(Authentication autenticazione) {
        ...
        UtenteDetailsImpl utentePrincipal = (UtenteDetailsImpl) autenticazione.getPrincipal();
